...
- (void)createViews
{
    ...
    /** ProFit MOD */
    if (_browserOptions.bgcolor != nil) { // Set bg color if user sets it in options
        self.webView.backgroundColor = [self colorFromHexString:_browserOptions.bgcolor];
        self.view.backgroundColor = [self colorFromHexString:_browserOptions.bgcolor];
    } else {
